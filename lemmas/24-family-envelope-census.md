...
- Status: Proven. The already audited family classes now cover:
  ...
  and `Rodd+` via the genuine parity-even STF rank-3 representative.
...
- Status: Proven. The smallest remaining unaudited class is now the parity-even even-rank tensor class `Reven4+`.
...
9. Status: Proven. The next remaining parity-even local tensor ranks not yet audited are even ranks `\ge 4`, with `Reven4+` the smallest.
