...
- Status: Proven. This lemma audits the R1-containing triple combinations `(R1, R2, R0a)`, `(R1, R2, R0b)`, `(R1, R0a, R0b)`, and the full enlarged audited set `(R2, R0a, R0b, R1)` at `\Delta \le 4`.
