...
- Status: Proven. This lemma audits the four new pairwise combinations that arise once the genuine primitive rank-3 STF class `Rodd+` is added to the already audited threshold set at `\Delta \le 4`.
