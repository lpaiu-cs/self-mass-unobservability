...
int getfield (char *, int, int, double *);
double exp10 (double);	// needed as include of math did not find exp10
 ...
 *                 1.01b. rlr.
 *   Sep 18, 2018 - clean up. V2?? rlr.
 *   Auf 23, 2019 - CRD v2 NA. rlr/
 *
**-----------------------------------------------------------------------*/
int
main (argc, argv)
...
/* Normalpoint Record */
  ...
  d11.signal_to_noise = NA_VALUEF;	// 101519 NA
