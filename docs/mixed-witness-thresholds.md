...
- Status: Proven. For the audited genuine rank-3 STF family class, `W_{\mathrm{self}} = 2` and `W_{\mathrm{mix}} = 3`, so the current threshold is sharp and self-dominated within the audited class.
- Status: Proven. For the audited genuine rank-4 STF family class, `W_{\mathrm{self}} = 2` and `W_{\mathrm{mix}} = 3`, so the current threshold is sharp and self-dominated within the audited class.
- Status: Proven. For the audited genuine rank-5 STF family class, `W_{\mathrm{self}} = 2` and `W_{\mathrm{mix}} = 3`, so the current threshold is sharp and self-dominated within the audited class.
