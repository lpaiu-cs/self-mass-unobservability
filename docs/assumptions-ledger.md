...
| A2 | Conjectural | The minimal M3 sector is nearly spherical, nonspinning, and parity-even. | Keeps the operator search space inside the minimal free-fall sector requested for this theorem candidate. | Spin, parity-odd structures, or large asphericity add new operator families at the same order. |
...
## Non-Assumption For M3

- Status: Proven. Finite invariant basis closure is not listed as an assumption in M3.
...
- Status: Conjectural. That burden is attacked explicitly in [`docs/theorem-A-freefall.md`](theorem-A-freefall.md) and [`../lemmas/06-normal-form-completeness-delta4.md`](../lemmas/06-normal-form-completeness-delta4.md), not hidden in the assumptions list.
