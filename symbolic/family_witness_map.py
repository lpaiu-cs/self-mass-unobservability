...
def family_witness_entries() -> tuple[FamilyWitness, ...]:
    ...
    entries = (
        ...
        FamilyWitness(
            ...
            weight=2,
            obstructed_theorem_layer="promotion of the enlarged audited-set result to MVP-envelope sufficiency; exhaustive bookkeeping patch now records omitted mixed cubic EEQ and companion rank-4 classes",
            finite_family_collapse_obstructed=False,
            harmless_without_extra_assumptions=False,
        ),
        FamilyWitness(
            ...
            weight=2,
            obstructed_theorem_layer="promotion of the enlarged audited-set result to MVP-envelope sufficiency; post-Rodd5+ composition closes, but the next live bottleneck is the high-rank exhaustiveness patch rather than the Reven6+ gate",
            finite_family_collapse_obstructed=False,
            harmless_without_extra_assumptions=False,
        ),
    )
