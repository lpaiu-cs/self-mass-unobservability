...
def family_witness_entries() -> tuple[FamilyWitness, ...]:
    ...
    entries = (
        ...
        FamilyWitness(
            ...
            weight=2,
            obstructed_theorem_layer="promotion of the enlarged audited-set result to MVP-envelope sufficiency; this class is also the first explicit failure point of the attempted uniform STF tower theorem",
            finite_family_collapse_obstructed=False,
            harmless_without_extra_assumptions=False,
        ),
        FamilyWitness(
