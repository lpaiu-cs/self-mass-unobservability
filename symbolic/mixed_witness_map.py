...
def mixed_witness_entries(delta_max: int = DELTA_MAX) -> tuple[MixedWitnessEntry, ...]:
    ...
    return (
        ...
        MixedWitnessEntry(
            ...
            self_weight=2,
            first_mixed_witness="EEQ and EQQ",
            mixed_weight=3,
            w_min=2,
            current_threshold_statement="w_Q >= 3, or explicit rule excluding or absorbing the primitive rank-4 family",
            theorem_layer_obstructed="promotion of the enlarged audited-set result to MVP-envelope sufficiency; this is the first audited even-rank exception to the attempted STF tower theorem",
            sharpness_status="self-only",
            confidence_level="Proven",
        ),
        MixedWitnessEntry(
        ...
        MixedWitnessEntry(
            ...
            first_self_witness="Z2",
            self_weight=2,
            first_mixed_witness="EZZ",
            mixed_weight=3,
            w_min=2,
            current_threshold_statement="w_Z >= 3, or explicit rule excluding or absorbing the primitive rank-6 family",
            theorem_layer_obstructed="promotion of the enlarged audited-set result to MVP-envelope sufficiency after the Rodd5+-closed composition layer",
            sharpness_status="self-only",
            confidence_level="Proven",
        ),
    )
