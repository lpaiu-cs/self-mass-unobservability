...
- Status: Counterexample candidate. The nonlinear second-order robustness map is recorded in [`../../docs/nonlinear-robustness-map.md`](../../docs/nonlinear-robustness-map.md) and checked in [`../../symbolic/nonlinear_robustness_map.py`](../../symbolic/nonlinear_robustness_map.py); it tests whether the conditional positive region persists across a finite grid in `p`, `e`, `rho`, `delta`, projection channel, and nuisance mode.
- Status: Counterexample candidate. The analytic phase-boundary theorem is recorded in [`../../docs/analytic-phase-boundary-theorem.md`](../../docs/analytic-phase-boundary-theorem.md) and checked in [`../../symbolic/analytic_phase_boundary.py`](../../symbolic/analytic_phase_boundary.py); it rewrites the robustness result as count, bracket, amplitude-usability, and rank-degeneracy boundaries.
